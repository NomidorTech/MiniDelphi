...
begin
  ...
  begin
    ...
    try
      Clear;
      Add('Pythia  --  Multi-Language Learning IDE');
      Add('"Py" in Pythia stands for Python.');
      Add('------------------------------------------------------');
      Add('');
      Add('Version 1.3   |   May 2026');
      Add('');
      Add('Copyright (c) 2026 Nomidor Software, LLC.');
      Add('All rights reserved.');
      Add('');
      Add('Licensed under the GNU General Public License v3.0');
      Add('See https://www.gnu.org/licenses/gpl-3.0.html');
      Add('');
      Add('Features:');
      Add('  * Built-in Pascal interpreter  (no install required)');
      Add('  * Python via snap-in runner pack  (python.exe on PATH)');
      Add('  * Pluggable runner system -- any language via .runner.ini');
      Add('  * Learn Pascal: 10 real-world lessons, 30 challenges');
      Add('  * Learn Python: 10 real-world lessons, 30 challenges');
      Add('  * Learn tabs created dynamically per installed runner');
      Add('  * 13 UI languages + external language pack system');
      Add('  * Compiler, Calculator, Projects, Forms tabs');
      Add('  * SQLite builtins (sqlite3.dll)');
      Add('  * 2D graphics window (GfxOpen, drawing primitives)');
      Add('  * Visual form builder for .mdfrm files');
      Add('  * Sudoku with daily challenges and SQLite saves');
      Add('  * Dark / Light / Follow Windows theme');
      Add('');
      ...
      Add('');
      Add('Portugues:');
      Add('Pythia  --  IDE de Aprendizado Multi-Linguagem');
      Add('"Py" em Pythia representa Python.');
      Add('  * Interpretador Pascal embutido (sem instalacao)');
      Add('  * Python via runner pack (python.exe no PATH)');
      Add('  * Sistema de runners plugavel -- qualquer linguagem');
      Add('  * Aprender Pascal: 10 licoes reais, 30 desafios');
      Add('  * Aprender Python: 10 licoes reais, 30 desafios');
      Add('  * 13 idiomas de interface + pacotes externos');
      Add('');
      Add('------------------------------------------------------');
      Add('');
      Add('Deutsch:    Pythia -- Mehrsprachige Lernumgebung.');
      Add('Espanol:    Pythia -- IDE de aprendizaje multi-lenguaje.');
      Add('Francais:   Pythia -- Environnement multi-langages.');
      Add('Italiano:   Pythia -- IDE di apprendimento multi-linguaggio.');
      Add('');
      Add('www.nomidor.com');
